...
function App() {
  ...
  const SubmitForm= async(e)=>{
   ...
   await axios.post(`https://email-api-server.vercel.app/api/pdf/createPdf`,data)//create pdf next=> get pdf
   .then(()=>
        axios.get(`https://email-api-server.vercel.app/api/pdf/fetchPdf`,{responseType:'blob'})//to fetch the generated pdf
        .then((res)=>{
        ...
        .then(()=>
          axios.post("https://email-api-server.vercel.app/api/pdf/sendPdf",{email:email})
          .then(response=>{
